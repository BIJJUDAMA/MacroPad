...
import { 
    ...
    Move, MousePointer, Scroll, Keyboard, ChevronDown, ChevronRight,
...
export const HelpPanel: React.FC = () => {
    ...
    const SectionHeader = ({ id, icon: Icon, title, colorClass }: { id: string, icon: any, title: string, colorClass: string }) => (
        ...
        >
            ...
            {expanded[id] ? <ChevronDown size={20} className="text-text-dim" /> : <ChevronRight size={20} className="text-text-dim" />}
        </button>
    );
