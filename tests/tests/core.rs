use macropad_core::models::{MacropadRec, Metadata, OriginType, PlaybackConfig, Event, EventType};
...
fn test_mouse_segment_consolidation() {
    let events = vec![
        Event { 
            ...
            time_ms: 0,
            x: Some(10), y: Some(10), 
            key: None, button: None, delta_x: None, delta_y: None, duration_ms: None, value: None, waypoints: None 
        },
        Event { 
            event_type: EventType::MouseMove, 
            time_ms: 50,
        ...
        Event { 
            ...
            time_ms: 100,
            key: Some("a".into()), 
            button: None, x: None, y: None, delta_x: None, delta_y: None, duration_ms: None, value: None, waypoints: None 
        },
    ];
